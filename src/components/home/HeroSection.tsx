    ...
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        ...
        <div className="mb-8 animate-fade-in">
          <img
            alt="Escudo CPTran"
            className="mx-auto h-36 w-36 md:h-48 md:w-48 object-contain drop-shadow-2xl animate-float"
            src={logoCptran}
          />
        </div>
        ...
        >
          <h1 className="font-display text-5xl md:text-7xl lg:text-8xl font-bold mb-4 text-white">
        ...
        >
          ...
          <Link to="/hierarquia">
            <Button
              variant="glass"
              size="xl"
              className="w-full sm:w-auto text-white border-white/30 hover:border-primary"
            >
